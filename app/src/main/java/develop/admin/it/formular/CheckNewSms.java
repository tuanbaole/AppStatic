...
public class CheckNewSms extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_check_new_sms);
        sideBarMenu();
        ...
        buttonDate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(CheckNewSms.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
        ...
        buttonSkipSmsErr.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (cursor1.getCount() > 0) {
                    ...
                    controller.showAlertDialog(CheckNewSms.this, "Tin nhắn chưa xử lý được", "SDT : " + address + "\n" + body);
                } else {
                    controller.showAlertDialog(CheckNewSms.this, "Thông báo", "đã xử lý hết tin nhắn");
                }
            }
        });
        ...
        buttonDeleteAllData.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                appdialog.Confirm(CheckNewSms.this, "Thông Báo", "Bạn có chắc xóa tất cả danh bạ đơn giá không?",
        ...
        buttonQuayLai.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (smsBackString.getCount() > 0) {
                    ...
                    textV = (EditText) findViewById(R.id.editTextMessage);
                    textV.setText("");
                    Toast.makeText(CheckNewSms.this, "Đã quay lại tin nhắn trước.làm ơn nhấn nút tính tiếp", Toast.LENGTH_LONG).show();
                }
            }
        });
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                ...
                switch (menuItem.getItemId()) {
                    case R.id.navigation_home:
                        Intent intent = new Intent(CheckNewSms.this, MainActivity.class);
                        startActivity(intent);
                        return true;
                    case R.id.unit_price:
                        Intent intent2 = new Intent(CheckNewSms.this, Contact.class);
                        startActivity(intent2);
                        return true;
                    case R.id.send_sms:
                        Intent intent3 = new Intent(CheckNewSms.this, Customer.class);
                        startActivity(intent3);
                        return true;
                    case R.id.manage_money:
                        Intent intent4 = new Intent(CheckNewSms.this, ManagerMoney.class);
                        startActivity(intent4);
                        return true;
                    case R.id.statistic:
                        Intent intent5 = new Intent(CheckNewSms.this, Statistic.class);
                        startActivity(intent5);
                        return true;
                    case R.id.SmsAgain:
                        Intent intent6 = new Intent(CheckNewSms.this, MainXoaCongNo.class);
    ...
    public Runnable aproc() {
        return new Runnable() {
            public void run() {
                ...
                sql = new DatabaseHelper(CheckNewSms.this);
                String table5 = sql.TABLE_NAME_5;
                String table6 = sql.TABLE_NAME_6;
                buttonDate = (Button) findViewById(R.id.buttonDate);
                String getDays = buttonDate.getText().toString();
                Toast.makeText(CheckNewSms.this, getDays, Toast.LENGTH_LONG).show();
                sql.deleteAllNgay(table5, getDays);
                sql.deleteAllNgay(table6, getDays);
                Toast.makeText(CheckNewSms.this, "Xóa thành công dữ liệu", Toast.LENGTH_LONG).show();
            }
        };
    }
    ...
    private void getKqsxmb(String dateDelete, String dateImport) {
        ...
        if (activeNetworkInfo != null && activeNetworkInfo.isConnected()) {
            ...
            controller.showAlertDialog(CheckNewSms.this, "Thông báo", "Không kết nối được internet");
        }
    }
    ...
    class ReadXml extends AsyncTask<String, Integer, String> {
        ...
        protected void onPostExecute(String s) {
            if (s.indexOf("false") == -1) {
                ...
                try {
                    ...
                    if (res.getCount() != 27) { // kiem tra da insert ket qua ngay hom nay
                        ...
                        if (kqsx2.getCount() != 27) {
                            controller.showAlertDialog(CheckNewSms.this, "Thông Báo",
                ...
                controller.showAlertDialog(CheckNewSms.this, "Thông Báo", "Chưa tìm thấy kết quả nào!");
            }
        }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        inflater.inflate(R.menu.send_sms_input, menu);
        return true;
    }
        ...
        switch (item.getItemId()) {
            case R.id.item_calculate:
                ...
                if (miligetHsd >= miliGetDay) {
                    ...
                    controller.showAlertDialog(CheckNewSms.this, "Thông báo", "Đã hết hạn sử dụng ứng dụng! làm ơn đăng kí sử dụng tiếp");
                }
                return true;
            case R.id.guitincanbang:
                Intent intent = new Intent(CheckNewSms.this, GuiTinCanBang.class);
                startActivity(intent);
                return true;
            case R.id.thongkeconso:
                Intent intent1 = new Intent(CheckNewSms.this, dataSmsShow.class);
                startActivity(intent1);
                return true;
            case R.id.caidaicanbang:
                Intent intent2 = new Intent(CheckNewSms.this, CaiDatCanBang.class);
                startActivity(intent2);
                return true;
        }
...
//                        vtritin.setText(idSms);
                ...
                controller.showAlertDialog(CheckNewSms.this, "Thông báo", "hãy làm sạch trước khi bấm nút");
            }
        }
    }
    ...
    public String checkMessage(String kitu, String getDays, String smsType) {
        ...
        ArrayList<String> compareLo = sql.getNotOkLo();
//        ArrayList<String> compareLo2 = sql.getNotOkLo(getDays);
//        ArrayList<String> compareLoDau = sql.getNotOkLo(getDays);
                                        ...
                                        if (mangDecoX.length == 2) {
                                            ...
                                            if (!mangDecoX[0].replaceAll("(^\\s+|\\s+$)", "").equals("")) {
                                                ...
                                                if (message[i].replaceAll("(^\\s+|\\s+$)", "").substring(0, 6).indexOf("bro") > -1) {
                                                    ...
                                                    sql.deleteSolieuSmsIDToDay(table5Bor, String.valueOf(idSmsInt), getDays, "de");
                                    ...
                                    if (tachChuoiLo.get(j).indexOf("x") > -1) { // kiem tra co dau x trong chuoi khong
                                        ...
                                        if (mangLocoX.length == 2) {
                                            ...
                                            if (!mangLocoX[0].replaceAll("(^\\s+|\\s+$)", "").equals("")) {
                                                ...
                                                if (message[i].replaceAll("(^\\s+|\\s+$)", "").substring(0, 6).indexOf("bro") > -1) {
                                                    String table5Bor = sql.TABLE_NAME_5;
                                                    sql.deleteSolieuSmsIDToDay(table5Bor, String.valueOf(idSmsInt), getDays, "lo");
                                                    for (int stt = 0; stt < 100; stt++) {
                                                        String broStt = "";
                                                        if (stt < 10) {
                                                            broStt = "0" + String.valueOf(stt);
